...
def quantize(model_path, quant_model_path):

    calibration_dataset = prepare_dataset(data_type='text-image')
    ...
    shutil.copy(spk_dict_path, quant_model_path)
...
if __name__ == "__main__":
    ...
    quant_model_path = f'{model_path}-GPTQ-thinker-talker'
    
    # quantize(model_path, quant_model_path)

    inference(quant_model_path)
